...
def deselected():
    ...
    bubbleb.grid(row=6, column=0, sticky=W)
    mergeb.grid(row=6, column=1, sticky=W)
    quickb.grid(row=6, column=2, sticky=W)
    radixb.grid(row=6, column=3, sticky=W)
    linearb.grid(row=6, column=4, sticky=W)
    stop.grid(row=7, column=0, columnspan=1)
    reset.grid(row=7, column=2, columnspan=1)
    start_.grid(row=7, column=4, columnspan=1)
...
bubbleb = Checkbutton(root, text="Bubble Sort", variable=bubble, onvalue=True, offvalue=False)
bubbleb.grid(row=6, column=0, sticky=W)
mergeb = Checkbutton(root, text="Merge Sort", variable=merge, onvalue=True, offvalue=False)
mergeb.grid(row=6, column=1, sticky=W)
quickb = Checkbutton(root, text="Quick Sort", variable=quick, onvalue=True, offvalue=False)
quickb.grid(row=6, column=2, sticky=W)
radixb = Checkbutton(root, text="Radix Sort", variable=radix, onvalue=True, offvalue=False)
radixb.grid(row=6, column=3, sticky=W)
linearb = Checkbutton(root, text="Linear Search", variable=linear, onvalue=True, offvalue=False)
linearb.grid(row=6, column=4, sticky=W)
