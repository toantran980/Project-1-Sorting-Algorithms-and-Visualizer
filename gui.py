...
def selected():
    ...
    bubble_.grid(row=4, column=0, sticky=W)
    merge_.grid(row=4, column=1, sticky=W)
    quick_.grid(row=4, column=2, sticky=W)
    radix_.grid(row=4, column=3, sticky=W)
    linear_.grid(row=4, column=4, sticky=W)
